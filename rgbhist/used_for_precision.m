files=dir('E:\taobao\upper body part\colorhist\distance125\color_sort_all\*.mat');%保存的是排好序的颜色匹配结果
s=0.0;
for i=1:length(files)
    file_name=files(i).name;
    I=file_name;
    I(end-3:end)=[];
    A=load(['E:\taobao\upper body part\colorhist\distance125\color_sort_all\',file_name]);%读文件到矩阵
