...
void FindJPG(const string & strDir)
{
	...
	str="E:\\taobao\\m\\"+str+".jpg";//剪切后的保存路径
...
{ 
    ...
    printf( "detection time = %gms\n", t/((double)cvGetTickFrequency()*1000.) );
		...
		cvSetImageROI(img,cvRect(r->x,r->y+r->height,100,80));
		copy_img=cvCreateImage(cvSize(100,80),  IPL_DEPTH_8U, img->nChannels);
